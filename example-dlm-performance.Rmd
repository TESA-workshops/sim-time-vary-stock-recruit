...
```
THis is a very quick and dirst example of fitting a DLM to a bunch of simulated data across a range of stock sizes/depletion and then visualizing mean % bias.
